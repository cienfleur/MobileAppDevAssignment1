...
class PlacemarkJSONStore : PlacemarkStore {
    ...
    override fun findOne(id: Long) : PlacemarkModel? {
        var foundPlacemark: PlacemarkModel? = placemarks.find { p -> p.id.toLong() == id }
        return foundPlacemark
    }

    override fun indexOf(placemark: PlacemarkModel): Int {
        return placemarks.indexOf(placemark)
    }
    ...
    override fun update(placemark: PlacemarkModel) {
        var foundPlacemark = findOne(placemark.id.toLong())
